                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 15.0, bottom: 5),
                                child: Text(
                                  'No Transaksi   : ${(detailTrx.dbHistoryTrx[0].noTrx!)}',
                                  style: TextStyle(
                                      fontSize: 15,
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 15.0, bottom: 5),
                                child: Text(
                                  'Tanggal / Jam  : ${DateFormat('dd/MM/yyyy HH:mm').format(DateTime.parse(detailTrx.dbHistoryTrx[0].createdAt!))}',
                                  style: TextStyle(
                                      fontSize: 15,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                      shrinkWrap: true,
                                      scrollDirection: Axis.vertical,
                                      itemCount: detailTrx.dbHistoryTrx.length,
                                      itemBuilder: (context, index) {
                                        return ListTile(
                                          ...
                                          title: Text(
                                            detailTrx.dbHistoryTrx[index]
                                                .namaBarang!,
                                            style:
                                                const TextStyle(fontSize: 15),
                                          ),
                                          subtitle: Text(
                                            '${detailTrx.dbHistoryTrx[index].totalItem} x ${CurrencyFormat.convertToIdr(detailTrx.dbHistoryTrx[index].hargaJual, 0)}',
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          CurrencyFormat.convertToIdr(
                                              detailTrx.dbHistoryTrx[0].total,
                                              0),
                                          style: const TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 15),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          CurrencyFormat.convertToIdr(
                                              detailTrx.dbHistoryTrx[0].kembali,
                                              0),
                                          style: const TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 15),
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton.icon(
                                        onPressed: () {
                                          PrintSettingState(
                                                  dataPrintDetail:
                                                      detailTrx.dbHistoryTrx,
                                                  dataPrint: null)
                                              .printDetail();
                                        },
                                        // onPressed: () => Get.to(() =>
                                        //     PrintSetting(
                                        //         data: detailTrx.dbHistoryTrx)),
