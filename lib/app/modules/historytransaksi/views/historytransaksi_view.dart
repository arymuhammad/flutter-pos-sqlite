                        ...
                        child: Container(
                          child: ListView.builder(
                              ...
                              itemBuilder: (ctx, index) {
                                int sum = historyCtr.searchTrx.fold(
                                    0, (total, dst) => total + dst.total!);
                                total = sum;
                                return Card(
                                  elevation: 5,
                                  child: ListTile(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Obx(() =>  Text(
                                  'Total ${CurrencyFormat.convertToIdr(historyCtr.totalTrx.value, 0).toString()}',
                                  style: const TextStyle(
