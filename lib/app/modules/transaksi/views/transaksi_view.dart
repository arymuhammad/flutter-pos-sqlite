...
import 'package:my_first_app/app/models/detail_trx_model_db.dart';
import 'package:my_first_app/app/models/trx_model_db.dart';
                  ...
                  Flexible(
                    child: TextField(
                      ...
                      onSubmitted: (data) async {
                        // if (transaksi.text == "" || transaksi.text.isEmpty) {
                        //   data = transaksiController.barcodeBarang.value;
                        // } else {
                        //   data = transaksi.text;
                        // }

                        // print('valeuuuuu  ${value}');
                        // print('barcodeeee  ${barcodeBarang}');
                        // if (transaksi.text.isNotEmpty ||
                        //     transaksiController.barcodeBarang.value.isNotEmpty) {
                        // } else {}
                        if (transaksi.text.isNotEmpty) {
                          ...
                          // for (var i = 0;
                          //     i < transaksiController.listdata.length;
                          //     i++) {
                          //   //getting the key direectly from the name of the key
                          //   totalScores += transaksiController.listdata[i];
                          // }
                          // transaksiController.total.value = totalScores.toInt();
                          // print(transaksiController.total.value);

                          final int index1 = transaksiController.dbBarang
                              .indexWhere(((book) =>
                          ...
                          if (transaksiController.dbBarang[index1].stok == 0) {
                            Fluttertoast.showToast(
                                msg:
                            ...
                            transaksiController.listdata.add(MasterBarangDb(
                                kodeBarang: int.parse(data),
                                namaBarang: transaksiController
                                    .dbBarang[index1].namaBarang,
                                hargaBarang: transaksiController
                                    .dbBarang[index1].hargaBarang,
                                // awal: transaksiController.dataBarang[index1].awal,
                                // masuk:
                                //     transaksiController.dataBarang[index1].masuk,
                                // keluar: 0,
                                // sisa:
                                //     transaksiController.dataBarang[index1].sisa
                                stok:
                                    transaksiController.dbBarang[index1].stok));
                            ...
                            onPressed: () {
                              if (transaksiController.listdata.isEmpty) {
                                ...
                                for (var e in transaksiController.listdata) {
                                  ...
                                  var dataItem = {
                                    'no_trx':
                                        '00${transaksiController.initNum.toString() + transaksiController.generateTrx.toString()}',
                                    'kode_barang': e.kodeBarang.toString(),
                                    'nama_barang': e.namaBarang.toString(),
                                    'harga_barang': e.hargaBarang.toString(),
                                    // 'qty_awal': e.sisa.toString(),
                                        ...
                                        onPressed: () {
                                          if (pembayaran.text.isNotEmpty) {
                                            ...
                                            for (var item in result) {
                                              ...
                                              SQLHelper.instance.upadteMasterBarang(
                                                  MasterBarangDb(
                                                      ...
                                                      namaBarang:
                                                          item['nama_barang'],
                                                      hargaBarang: int.parse(
                                                          item[
                                                              'harga_barang'])));

                                              SQLHelper.instance.insertTrxDet(DetailTrxDb(
                                            ...
                                            //     dataPenjualan);
                                            SQLHelper.instance.insertTrx(TrxDb(
                                                noTrx: transaksiController
                                                        .initNum
                                                        .toInt() +
                                                    transaksiController
                                            ...
                                            PrintSettingState(
                                                    dataPrint: dataPrint, dataPrintDetail: null)
                                                .printStruk();
  ...
  scanBarcodeDiscovery() async {
    ...
    try {
      ...
      transaksiController.listdata.add(MasterBarangDb(
          ...
          namaBarang: transaksiController.dbBarang[index1].namaBarang,
          hargaBarang: transaksiController.dbBarang[index1].hargaBarang,
          // awal: transaksiController.dataBarang[index1].awal,
          // masuk: transaksiController.dataBarang[index1].masuk,
          // keluar: 0,
          // sisa: transaksiController.dataBarang[index1].sisa
          stok: transaksiController.dbBarang[index1].stok));
      transaksi.clear();
      myFocusNode.requestFocus();
      var initialV = 0;
      int sum = transaksiController.listdata.fold(
