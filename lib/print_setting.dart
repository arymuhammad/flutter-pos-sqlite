...
import 'app/models/detail_trx_model_db.dart';
...
class PrintSettingState extends State<PrintSetting> {
  ...
  final RxList<DetailTrxDb>? dataPrintDetail;
    ...
    bluetoothPrint.state.listen((state) async {
      ...
      if (state == 12 && isConnected!) {
        ...
        list.add(LineText(
          type: LineText.TYPE_TEXT,
          content:
              'Tanggal/jam : ${DateFormat('dd/MM/yyyy HH:mm').format(DateTime.parse(dataPrintDetail![0].createdAt!))}',
          // width: 2,
          // height: 2,
          weight: 2,
          align: LineText.ALIGN_LEFT,
        ...
        list.add(LineText(
          type: LineText.TYPE_TEXT,
          content:
              'Kembali ${NumberFormat.simpleCurrency(locale: 'in', decimalDigits: 0).format(dataPrintDetail![0].kembali)}\n\n',
          // width: 1,
          // height: 1,
          // weight: 1,
          align: LineText.ALIGN_RIGHT,
